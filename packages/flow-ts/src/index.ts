// Public umbrella entry point. Re-exports the merged modules
// (strata, catalog, optimizing, planning, reading, executing). They
// used to be six separate workspace packages; collapsing them into a
// single package matches how they actually compose at runtime and
// keeps consumer imports simple.
//
