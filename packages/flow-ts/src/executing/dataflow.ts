...
import { type Row, type Value, constToValue, decodeRow, encodeRow } from '../reading/index.js'
...
type TArg = import('../planning/index.js').TransformationArgument
type FactorArg = import('../planning/index.js').FactorArgument
type ArithArg = import('../planning/index.js').ArithmeticArgument
type CompareArg = import('../planning/index.js').ComparisonExprArgument
type BaseConstraintsT = import('../planning/index.js').BaseConstraints
...
function projectionIds(
  args: readonly import('../planning/index.js').TransformationArgument[],
  ctx: string,
): [boolean, number][] {
  return args.map((a) => {
